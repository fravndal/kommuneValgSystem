...
CREATE TABLE forhåndsstemmesteder (
  id int(10) not null,
  forhåndsstemmested varchar(50) not null,
  adresse varchar(50) not null,
  postnr_sted varchar(50) not null,
  gps_koordinater varchar(50) not null
);

INSERT INTO forhåndsstemmesteder(id, forhåndsstemmested, adresse, postnr_sted, gps_koordinater) VALUES( 1, "0001 Kuben senter", "Kong Rings gate 1", "3510 Hønefoss", "60.16547, 10.25824");

INSERT INTO forhåndsstemmesteder(id, forhåndsstemmested, adresse, postnr_sted, gps_koordinater) VALUES( 2, "0002 Fossetorget", "Hønefoss Bru 1E", "3510 Hønefoss", "60.16702, 10.25731");

INSERT INTO forhåndsstemmesteder(id, forhåndsstemmested, adresse, postnr_sted, gps_koordinater) VALUES( 3, "0003 Ringerike Rådhus", "Osloveien 1", "3511 Hønefoss", "60.16019, 10.25652");

INSERT INTO forhåndsstemmesteder(id, forhåndsstemmested, adresse, postnr_sted, gps_koordinater) VALUES( 4, "0004 Eikli", "Barboveien 7", "3511 Hønefoss", "60.15316, 10.24892");

INSERT INTO forhåndsstemmesteder(id, forhåndsstemmested, adresse, postnr_sted, gps_koordinater) VALUES( 5, "0005 Mega Hønegata", "Industrigata 1", "3515 Hønefoss", "60.17682, 10.27151");

CREATE TABLE `stemmestyre` (
  `bruker_id` int(11) NOT NULL,
  `kretsNr` int(10) NOT NULL,
  `rolle` varchar(50) COLLATE utf8mb4_bin DEFAULT NULL,
  `navn` char(100) COLLATE utf8mb4_bin NOT NULL,
...
ALTER TABLE `stemmestyre`
  ADD CONSTRAINT `stemmestyre_ibfk_1` FOREIGN KEY (`bruker_id`) REFERENCES `brukere` (`id`);
  
ALTER TABLE `stemmestyre`
  ADD CONSTRAINT `stemmestyre_ibfk_2` FOREIGN KEY (`kretsNr`) REFERENCES `stemmesteder` (`kretsNr`);
